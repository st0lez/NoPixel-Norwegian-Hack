...
const QUESTIONS = {
    'bakgrunns farge' : (d) => d.colors['background'],
    'farge tekst bakgrunnsfarge' : (d) => d.colors['colortext'],
    'form tekst bakgrunnsfarge    ' : (d) => d.colors['shapetext'],
    'nummer farge' : (d) => d.colors['number'],
    'form farge' : (d) => d.colors['shape'],
    'farge tekst' : (d) => d.text[0],
    'form tekst' : (d) => d.text[1],
    'form' : (d) => d.shape
}
